...
"""		
		...
		print C + "If you have any ideas on what to put here. Contact me and we can talk :D"
		print C + "Or if you would like to sponsor you're own tool here contact me also!"
	else:
